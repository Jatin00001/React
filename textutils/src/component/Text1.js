...
export default function Text1(props) {
    ...
    const handleUpClick = ()=>{
        ...
        setText(newtext);
        props.showalert('success',"Text change into Uppercase ");
        // console.log(text);
    }
    ...
    const handleLcClick = ()=>{
        ...
        setText(newtext);
        props.showalert('success',"Text change into LowerCase ");
        // console.log(text);
    }
    ...
    const handleFuprCaseClick = ()=> {
        ...
        console.log(ans);
        setText(ans);
        props.showalert('success',"First Letter into Uppercase ");
    ...
    const handlecopyClick = ()=> {
        ...
        if(text === ""){
            ...
            return alert("Enter text for Copy.");
        }else{
    ...
    return(
        ...
        <div className="container my-" style={{color : props.mode === 'dark'? 'white':'black'}}>
            ...
            <p>{text.split(" ").filter((element)=>{return element.length!==0 }).length} words and {text.length} of Characters</p>
            {/* <p>text split is {text.split(" ")}</p> */}
            <p>{0.008 * text.split(" ").filter((element)=>{return element.length!==0 }).length} Minutes for read this text</p>
            <h4><p>Preview</p></h4>
